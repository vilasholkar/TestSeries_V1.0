...
using OnlineTestApplication.Models;
using OnlineTestApplication.Providers;
using OnlineTestApplication.Results;
...
namespace OnlineTestApplication.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            return Request.CreateResponse(HttpStatusCode.OK, _iBAccount.ForgetPassword(objForgetPassword));
        }
        /// </summary>
